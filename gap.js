...
(function() {
  var Gap, GapClickTracker, GapReadTracker, root;
  ...
  GapClickTracker = (function() {
    function GapClickTracker() {}

    GapClickTracker.prototype.listen = function(commandArray) {
      if (commandArray.length === 1 && commandArray[0] === "_gapTrackClicks") {
        return root.document.getElementsByTagName("body")[0].onmousedown = function(event) {
          ...
          if ((target != null) && (target.nodeName === "A" || target.nodeName === "BUTTON")) {
            ...
            href = target.href || "";
            return root._gap.push(["_trackEvent", "gapClick", text.replace(/^\s+|\s+$/g, "") + " (" + href + ")"]);
          }
        };
      }
    };

    return GapClickTracker;
  ...
  (function() {
    ...
    ga.onload = ga.onreadystatechange = function() {
      ...
      return root._gap = new Gap(root._gap, [new GapReadTracker(), new GapClickTracker()]);
    };
